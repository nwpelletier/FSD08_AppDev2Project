...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSD08_AppDev2Project.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FSD08_AppDev2Project.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FSD08_AppDev2Project.Models.AppliedJob", b =>
                {
                    b.HasOne("FSD08_AppDev2Project.Models.ApplicationUser", "Applicant")
                        .WithMany()
                        .HasForeignKey("ApplicantId");

                    b.HasOne("FSD08_AppDev2Project.Models.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
            ...
            modelBuilder.Entity("FSD08_AppDev2Project.Models.Review", b =>
                {
                    b.HasOne("FSD08_AppDev2Project.Models.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FSD08_AppDev2Project.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FSD08_AppDev2Project.Models.ApplicationUser", b =>
                {
                    b.HasOne("FSD08_AppDev2Project.Models.Company", null)
